...
tab1, tab2, tab3 = st.tabs(["View Sets", "Create New Set", "Add / Remove Artifacts"])
...
# ------ Tab 3: Add / Remove Artifacts 
with tab3:
    st.subheader("Add or Remove Artifacts from a Set ")

    col1, col2 = st.columns(2)
    with col1:
        set_id = st.number_input("Artifact Set ID", min_value=1, step=1)
    with col2:
